...
logger = logging.getLogger("claw-agent.integrations.jira")
...
class JiraIntegration:
    ...
    def update_ticket(self, ticket_key: str, **fields: Any) -> dict[str, Any]:
        self._logger.info(
            "Updating ticket %s with fields: %s", ticket_key, list(fields.keys())
        )
    ...
    def link_github_issue(
        ...
        self._logger.info(
            "Linking GitHub issue %s to ticket %s", github_url, ticket_key
        )
